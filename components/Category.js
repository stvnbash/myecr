...
export default function Category({ title, oid, cards, role }) {
    ...
    return (
        items.length > 0
            ? <div className="mb-10">
                <h2 className="mb-1 px-5 text-3xl font-semibold p-2 border-b">{title}</h2>
                {/* <hr /> */}
                <div className="pt-5 grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 gap-1 sm:gap-4 overflow-hidden">
